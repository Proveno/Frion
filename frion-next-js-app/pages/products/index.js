        ...
        <div>
            ...
            >
                ...
                <div className={`flex justify-between w-full`}>
                    <div className={`mx-12 w-full self-center flex justify-start`}>
                        <div className="flex w-1/2 pl-16">
                        <input className="w-full rounded-lg px-2 mr-2"  placeholder="Enter title...">
                        </input>
